...
final_test = pd.concat([temp_X,temp_Y],axis=1)
...
final_train.to_csv('./URDU/urdu_train.csv',index = False)
#final_val.to_csv('./SHEMO/shemo_val.csv',index = False)
final_test.to_csv('./URDU/urdu_test.csv',index = False)
