...
def write_savee_csv(data_path, csv_name="savee.csv", verbose=1):
    target = {"path": [], "emotion": []}
    ...
    if verbose:
        print("[SAVEE-DB] Total files to write:", len(target['path']))
...
if __name__ == '__main__':
    ...
    with open(data_path +  '/savee.pkl', 'wb') as f:
